 ...
 */
public class NgokoLuguContohFragment extends Fragment {


    public NgokoLuguContohFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ngoko_lugu_contoh, container, false);
