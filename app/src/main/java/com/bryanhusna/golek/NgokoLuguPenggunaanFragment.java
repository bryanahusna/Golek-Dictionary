 ...
 */
public class NgokoLuguPenggunaanFragment extends Fragment {


    public NgokoLuguPenggunaanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ngoko_lugu_penggunaan, container, false);
